...
Ext.Loader.addClassPathMappings({
  ...
  "NumberWithSeperator": "../../app/view/layout/ScoreCardView.js",
  "PWApp2": "../../app",
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "NumberWithSeperator": [],
  "PWApp2.Application": [],
  "PWApp2.controller.FilterController": [],
  "PWApp2.controller.HelpController": [],
  "PWApp2.controller.LegendController": [],
  "PWApp2.controller.MapController": [],
  "PWApp2.controller.NationalController": [],
  "PWApp2.controller.RecordController": [],
  "PWApp2.controller.ScoreCardController": [],
  "PWApp2.model.BasinModel": [],
  "PWApp2.model.FormationModel": [],
  "PWApp2.model.RecordModel": [],
  "PWApp2.store.BasinStore": [],
  "PWApp2.store.ChemStore": [],
  "PWApp2.store.FormationStore": [],
  "PWApp2.store.IDDBStore": [],
  "PWApp2.store.MathStore": [],
  "PWApp2.store.RecordStore": [],
  "PWApp2.store.StateStore": [],
  "PWApp2.store.WellTypeStore": [],
  "PWApp2.view.Viewport": [],
  "PWApp2.view.filter.BasinLineView": [],
  "PWApp2.view.filter.ChemLineView": [],
  "PWApp2.view.filter.LatLonLineView": [],
  "PWApp2.view.filter.View": [],
  "PWApp2.view.layout.CiteListView": [],
  "PWApp2.view.layout.HelpView": [],
  "PWApp2.view.layout.LegendView": [],
  "PWApp2.view.layout.MapView": [],
  "PWApp2.view.layout.NationalView": [],
  "PWApp2.view.layout.RecordView": [],
  "PWApp2.view.layout.ScoreCardView": [],
  "countryWindow": []
});
Ext.ClassManager.addNameAliasMappings({
  ...
  "PWApp2.view.filter.LatLonLineView": [
    "widget.filter.latlonlineview"
  ],
  "PWApp2.view.filter.View": [
    "widget.filter.view"
  ],
  "PWApp2.view.layout.CiteListView": [
    "widget.layout.citelistview"
  ],
  "PWApp2.view.layout.HelpView": [
    "widget.layout.helpview"
  ],
  "PWApp2.view.layout.LegendView": [
    "widget.layout.legendview"
  ],
  "PWApp2.view.layout.MapView": [
    "widget.layout.mapview"
  ],
  "PWApp2.view.layout.NationalView": [
    "widget.layout.nationalview"
  ],
  "PWApp2.view.layout.RecordView": [
    "widget.layout.recordview"
  ],
  "PWApp2.view.layout.ScoreCardView": [
    "widget.layout.scorecardview"
  ],
  "countryWindow": []
});
